...
const users = {
  student: [{ id: 'S101', name: 'A.S.DIVYAN', role: 'student' },
            { id: 'S102', name: 'S.HARISH', role: 'student' },
            { id: 'S103', name: 'R.BHARATHWAJ', role: 'student' }],
  faculty: [{ id: 'F201', name: 'Mrs. T.ANITHA', role: 'faculty' },
